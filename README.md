...
docker stop MLColorDetectDev && docker rm -v MLColorDetectDev && docker run -d -p 60001:8000 --restart always --cpus 1 -m 512m  --security-opt seccomp:unconfined --name MLColorDetectDev ss_combdet:v1.1
```